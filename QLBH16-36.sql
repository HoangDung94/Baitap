...
--30.
SELECT MASP, TENSP FROM SANPHAM
WHERE NUOCSX = 'TRUNG QUOC' AND GIA IN (SELECT DISTINCT TOP 3 GIA FROM SANPHAM ORDER BY GIA DESC)
--31.
SELECT TOP 3 MAKH, HOTEN FROM KHACHHANG ORDER BY DOANHSO DESC
--32.
SELECT COUNT(DISTINCT MASP) AS 'TỔNG SỐ SP CỦA TQ' FROM SANPHAM
WHERE NUOCSX = 'TRUNG QUOC'
--33.
SELECT NUOCSX, COUNT(DISTINCT MASP) AS 'TỔNG SÓ SP' FROM SANPHAM GROUP BY NUOCSX
--34.
